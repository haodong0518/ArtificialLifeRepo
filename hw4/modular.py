...
def build_unit(parent, name, pos):
    ...
    geom_free_plate = ET.SubElement(top, "geom", type = "box",name = f"{name}geom_free_plate", size=".1 .5 .5", rgba ="0.9 0 0 1" )
    ...
    geom_hingex_box =ET.SubElement(hingex_box_body, "geom", type = "box", name = f"{name}geom_hingex_box", size ="0.5 0.1 0.1", rgba = "0.9 0 0 1" )
    ...
    geom_slide_plate = ET.SubElement(slide_plate, "geom", type = "box", name = f"{name}slide_plate", size ="0.1 .5 .5", rgba = "0 0 0 1")
